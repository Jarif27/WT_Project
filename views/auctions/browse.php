...
<div id="listingContainer" class="listing-grid">
    ...
    <?php foreach ($listings as $listing) { ?>
        ...
        <div class="auction-card">
            <img src="/Task-3/public/uploads/<?php echo $listing['image_path']; ?>" alt="Auction Image">
            ...
            <a class="btn" href="/Task-3/views/auctions/detail.php?id=<?php echo $listing['id']; ?>">
                View Details
            </a>
        </div>
...
<script src="/Task-3/public/js/browse.js"></script>
